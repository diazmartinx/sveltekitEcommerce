...
<div class="p-2">
	...
	{:else}
		<div class="flex flex-row items-center gap-1">
			...
			{:else if total < max}
				<progress class="progress progress-warning w-56 bg-neutral" value={$progress} {max} />
			{:else if total >= max}
				<progress class="progress progress-success w-56 bg-neutral" value={$progress} {max} />
			{/if}
